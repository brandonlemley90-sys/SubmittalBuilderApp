...
echo "  - Repository name: DenierSubmittalBuilderUpdates (or press enter)"
echo ""
...
echo "   - Repository name: DenierSubmittalBuilderUpdates"
echo "   - Make it PUBLIC"
...
echo "   Visit: https://brandonlemley90-sys.github.io/DenierSubmittalBuilderUpdates/version.json"
echo ""
